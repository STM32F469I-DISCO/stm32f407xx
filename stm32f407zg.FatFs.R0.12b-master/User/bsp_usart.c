...
void Usart_Init(void)
{
        ...
        /* 第一步：使能外设时钟 */
        RCC_AHB1PeriphClockCmd(USART_TX_GPIO_CLK, ENABLE);
        RCC_AHB1PeriphClockCmd(USART_RX_GPIO_CLK, ENABLE);
        ...
        /* 第四步：初始化设置 */
        USART_InitStructure.USART_BaudRate = USART_BAUDRATE;            // 根据宏设置波特率
...
/**
 * @Description 串口中断服务函数，每有接收一个字节，申请一次中断，中断函数里面接收，直到接收到换行停止接收
 */
